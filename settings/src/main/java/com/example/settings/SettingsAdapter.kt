...
import com.example.settings.databinding.ItemSettingBinding
import java.util.*
    ...
    override fun onBindViewHolder(holder: SettingViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            when (settings[position]) {
                parent.getString(coreR.string.change_language) -> Locale.setDefault(Locale("en_en"))
                parent.getString(coreR.string.change_theme) -> {
