...
class ExecutorsNominatorText(
    override val ticketFieldsParams: TicketFieldParams,
    private val ticket: MutableState<TicketEntity>,
    override val fieldEnum: TicketFieldsEnum = TicketFieldsEnum.EXECUTORS_NOMINATOR,
    ...
    fun Content() {
        ...
        Component(
            title = "Ответственный за назначение специалиста(-ов) для исполнения",
            icon = R.drawable.ic_baseline_person_24,
            label = ticket.value.executors_nominator?.getFullName() ?: "[Не определен]",
