...
class QualityControllerNominatorText(
    override val ticketFieldsParams: TicketFieldParams,
    private val ticket: MutableState<TicketEntity>,
    override val fieldEnum: TicketFieldsEnum = TicketFieldsEnum.QUALITY_CONTROLLERS_NOMINATOR,
    ...
    fun Content() {
        ...
        Component(
            title = "Ответственный за назначение специалиста(-ов) по контролю качества",
            icon = R.drawable.ic_baseline_person_24,
            label = ticket.value.quality_controllers_nominator?.getFullName() ?: "[Не определен]",
